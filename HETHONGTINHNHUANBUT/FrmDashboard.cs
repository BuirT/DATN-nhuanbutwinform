...
namespace HETHONGTINHNHUANBUT
{
    public partial class FrmDashboard : Form
    {
        ...
        {
            this.lblUpdate.Left = this.pnlHeader.Width - this.lblUpdate.Width - 5;
        }
        ...
        private async Task LoadChartNBThangAsync()
        {
            try
            {
                ...
                chartNBThang.Legend.Display = false; // Ẩn chú thích để rộng biểu đồ
                chartNBThang.Update();
            }
            catch { }
        }
        ...
        private async Task LoadChartTopPVAsync()
        {
            try
            {
                ...
                chartTopPV.Legend.Display = false; // Ẩn chú thích
                chartTopPV.Update();
            }
            catch { }
        }
        ...
        private async Task LoadChartBaiTheoCMAsync()
        {
            try
            {
                ...
                chartBaiTheoCM.Legend.Position = LegendPosition.Bottom; // Đẩy chú thích xuống đáy
        ...
        private async Task LoadChartDiemAIAsync()
        {
            try
            {
                ...
                chartDiemAI.Legend.Display = false; // Ẩn chú thích
                chartDiemAI.Update();
            }
            catch { }
        }
